 ...
 */
// 3000 px по длинной стороне — это:
// - 300 DPI для печати до 25×38 см (достаточно для большинства клиентов)
// - 2-3 МБ на файл (в 4-5 раз больше места, чем 2048 px)
// - по-прежнему отлично для AI-анализа
// Если нужны оригиналы для печати >30 см — клиент грузит в Google Drive/Dropbox.
